...
import com.dyq.design.design.pattern.example.behavioral_mode.observer_pattern.type1.*;
...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        IObserver xiaoMing = new NewsObserver("小明");
        IObserver xiaoWang = new SportsObserver("小王");
        IObserver xiaoLi = new StockObserver("小李");
        
        ISubject boss = new NotifySubject();
